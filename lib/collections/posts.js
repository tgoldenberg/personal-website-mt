...
Posts.allow({
  update: function(userId, post) { return userId == "f8eAFHhRX96oi9FRN" },
  remove: function(userId, post) { return userId == "f8eAFHhRX96oi9FRN" },
  insert: function(userId, post) { return userId == "f8eAFHhRX96oi9FRN" },
});
