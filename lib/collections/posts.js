...
Posts.allow({
  update: function(userId, post) { return userId == "6TXMpjPSbWfcqevAo" },
  remove: function(userId, post) { return userId == "6TXMpjPSbWfcqevAo" },
  insert: function(userId, post) { return userId == "6TXMpjPSbWfcqevAo" },
});
