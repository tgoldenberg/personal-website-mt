...
Posts.allow({
  update: function(post) { return userId == "f8eAFHhRX96oi9FRN"; },
  remove: function(post) { return userId == "f8eAFHhRX96oi9FRN"; },
  insert: function(post) { return userId == "f8eAFHhRX96oi9FRN"; }
});
