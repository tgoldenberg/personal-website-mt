Router.configure({
  ...
  waitOn: function() {
    return [Meteor.subscribe('sentences')];
  }
});
...
Router.route('/companies', {name: 'companies'});
Router.route('/collaborate', {name: 'collaborate'});
Router.route('/india', {name: 'india'});
Router.route('/sanskrit', {name: 'sanskrit'});
